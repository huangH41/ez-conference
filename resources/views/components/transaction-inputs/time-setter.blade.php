<div class="time-setter">
    ...
    <div class="time-setter__container">
        <div class="transaction-input__input-group">
            <div class="transaction-input__input-control" id="next-hour">
                <img class="arrow arrow__vertical--regular" src="/assets/icons/arrow-up.svg" alt="Top">
            </div>

            <div class="time-setter__slider">
                <div id="hour-input">
                    <div class="transaction-input__input-label hero">00</div>
            ...
            <div class="transaction-input__input-control" id="prev-hour">
                <img class="arrow arrow__vertical--regular" src="/assets/icons/arrow-down.svg" alt="Top">
            </div>
        </div>

        <div class="time-setter__divider">:</div>

        <div class="transaction-input__input-group">
            <div class="transaction-input__input-control" id="next-minute">
                <img class="arrow arrow__vertical--regular" src="/assets/icons/arrow-up.svg" alt="Top">
            </div>
            ...
            <div class="time-setter__slider">
                <div id="minute-input">
                    ...
                    <div class="transaction-input__input-label hero">10</div>
                    <div class="transaction-input__input-label hero">20</div>
                    <div class="transaction-input__input-label hero">30</div>
                    <div class="transaction-input__input-label hero">40</div>
                    <div class="transaction-input__input-label hero">50</div>
                </div>
            </div>

            <div class="transaction-input__input-control" id="prev-minute">
                <img class="arrow arrow__vertical--regular" src="/assets/icons/arrow-down.svg" alt="Top">
            </div>
        </div>
    </div>
